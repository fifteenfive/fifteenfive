...
const WriteReview = ({ wineName, rating, fileName, elements, changeImage, changeContent, changeRating, onSubmit, changeElement }) => {
  return (
    <div className={styles.container}>
      {/* <h1>와인 리뷰</h1>
      <p style={{ color: "#929292", cursor: "default" }}>와인에 대한 설명을 남겨주세요</p> */}
      ...
      <div className={styles.forms}> 
        <textarea cols="30" rows="11" placeholder="와인에 대한 평을 남겨 주세요(5자 이상 100자 이내)" onChange={changeContent}></textarea>
