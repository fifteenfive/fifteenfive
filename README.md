...
> 15.5도는 국내에서 유통되고 있는 와인 1,695종, 글로벌 와인 애호가 15,135명의 리뷰 101,314개를 기반으로<br> 최적의 와인을 추천 드립니다.<br/>

**협업 필터링 추천 알고리즘**을 기반으로 추천 로직을 구현하였으며 <br>**'라이프스타일'** 콘셉트를 도입하여
협업 필터링 알고리즘의 최대 약점인 콜드스타트 문제<br>
(첫 가입 유저는 상품에 대한 평가데이터가 없어 추천해주지 못하는 문제)를 해결함과 동시에<br>
